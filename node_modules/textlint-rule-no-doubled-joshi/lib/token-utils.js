...
exports.restoreToSurfaceFromKey = exports.createKeyFromKey = exports.concatJoishiTokens = exports.create読点Matcher = exports.is助詞Token = void 0;
...
var create読点Matcher = commaCharacters => {
  return function is読点Token(token) {
    return commaCharacters.includes(token.surface_form) && ( // 、や, は名詞扱い
